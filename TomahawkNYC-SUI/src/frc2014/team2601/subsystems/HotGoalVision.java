 ...
 *
 * @author steelhawks
 * This class is based on the code from FRC's VisionSampleProject2014
 */
public class HotGoalVision extends Subsystem {
    ...
    final int AREA_MINIMUM = 100; //150;  original value -pfw
    ...
    public boolean checkHotGoal() {
        ...
        try {
             ...
             */
            //image.write("/original.bmp");  // save original file for debugging

            BinaryImage thresholdImage = image.thresholdRGB(10, 150, 100, 255, 0, 255);  //used RGB because didn't want to distort original camera settings
//                BinaryImage thresholdImage = image.thresholdHSV(105, 137, 100, 255, 133, 183);   // keep only green objects
