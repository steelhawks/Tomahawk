...
public class Map {
    ...
    //Drivetrain
    public static final int FRONT_LEFT_MOTOR = 1; //Digital Sidecar
    public static final int FRONT_RIGHT_MOTOR = 3; //Digital Sidecar
    public static final int REAR_LEFT_MOTOR = 2; //Digital Sidecar
    public static final int REAR_RIGHT_MOTOR = 4; //Digital Sidecar
    public static final int GYRO = 2; //Analog Breakout
    ...
    public static final int COMPRESSOR_RELAY = 1; //Digital Sidecar
    
    //Lights
    public static final int BLUE_LIGHT_RELAY = 3; //Digital Sidecar//Old4
    public static final int RED_LIGHT_RELAY = 4; //Digital Sidecar//Old3
